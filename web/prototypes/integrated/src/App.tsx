    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#080812", color: "#c8c8d8", fontFamily: "system-ui, sans-serif", overflow: "hidden" }}>
      ...
      <header style={{
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button
            onClick={dataMode === "timeline" ? switchToMock : dataMode === "mock" ? loadReal : switchToMock}
            disabled={loading}
            style={{
              padding: "4px 12px", fontSize: 11, fontWeight: 500,
              background: dataMode === "real" ? "rgba(46, 204, 113, 0.15)" : dataMode === "timeline" ? "rgba(232,160,64,0.12)" : "rgba(255,255,255,0.05)",
              color: dataMode === "real" ? "#2ecc71" : dataMode === "timeline" ? "#e8a040" : "#888",
              border: `1px solid ${dataMode === "real" ? "rgba(46,204,113,0.3)" : dataMode === "timeline" ? "rgba(232,160,64,0.25)" : "#333"}`,
              borderRadius: 4, cursor: loading ? "wait" : "pointer",
            }}
          >
            {loading ? "Loading..." : dataMode === "real" ? "Real data" : dataMode === "timeline" ? "Timeline" : "Mock data"}
          </button>
